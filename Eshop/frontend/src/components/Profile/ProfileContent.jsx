...
const AllRefundOrders = () => {
  ...
  const eligibleOrders =
    orders && orders.filter((item) => item.status === "Đang xử lý tiền hoàn lại");
...
const Address = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (addressType === "" || country === "" || city === "") {
      toast.error("Vui lòng điền hết tất cả thông tin!");
    } else {
      dispatch(
        updatUserAddress(
          country,
            ...
            <div className="w-full">
              <form aria-required onSubmit={handleSubmit} className="w-full">
                <div className="w-full block p-4">
                  ...
                  <div className="w-full pb-2">
                    <label className="block pb-2">Chọn loại địa chỉ</label>
                    <select
                      name=""
                      id=""
                      value={addressType}
