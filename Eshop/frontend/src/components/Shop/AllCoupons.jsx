                ...
                <form onSubmit={handleSubmit} aria-required={true}>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Nhập số tiền tối thiểu của mã phiếu giảm giá của bạn..."
                    />
                  </div>
                  <br />
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Nhập số tiền tối đa của mã phiếu giảm giá của bạn..."
                    />
                  </div>
                  <br />
                  <div>
                    ...
                    >
                      <option value="Choose your selected products">
                        Chọn sản phẩm bạn muốn giảm giá
                      </option>
                      {products &&
                        products.map((i) => (
                  ...
                  <div>
                    <input
                      type="submit"
                      value="Đồng ý"
                      className="mt-2 appearance-none block w-full px-3 h-[35px] border border-gray-300 rounded-[3px] placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-black text-white"
                    />
                  </div>
                </form>
              </div>
